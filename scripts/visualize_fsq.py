...
def main():
    parser = argparse.ArgumentParser(description="Visualize FSQ-VAE input/output alongside original video")
    ...
    while True:
        if not paused:
            ...
            cv2.putText(combined, "Sobel 64x64", (dw + 10, 25),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 1)
            cv2.putText(combined, "FSQ Reconstruction", (dw + panel_size + 10, 25),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 1)
