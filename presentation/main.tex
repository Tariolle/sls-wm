...
\begin{frame}{Data Augmentation: Spatial Shifts}
  ...
  \begin{itemize}
    ...
    \item Vertical shifts simulate different stage elevations (identical dynamics, physically valid)
...
\begin{frame}[allowframebreaks]{References}
  ...
  \begin{itemize}
    ...
    \item Charraut, V. et al. (2026). \textit{LeWorldModel: Stable End-to-End Joint-Embedding Predictive Architecture from Pixels}. arXiv:2603.19312
    \item Peebles, W. \& Xie, S. (2023). \textit{Scalable Diffusion Models with Transformers} (DiT). arXiv:2212.09748
    \item Esser, P. et al. (2024). \textit{Scaling Rectified Flow Transformers for High-Resolution Image Synthesis} (SD3). arXiv:2403.03206
